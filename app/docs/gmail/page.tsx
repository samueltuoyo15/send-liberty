    ...
    <div className="max-w-3xl">
      ...
      <div className="space-y-6 text-secondary leading-relaxed">
        ...
        <div className="p-4 border border-indigo-100 bg-indigo-50/50 rounded-xl text-[#505f76] text-sm">
          <strong className="text-primary-sendlib">Daily Limits:</strong> Personal/product Gmail accounts send up to 200 emails/day on Free (500/day on Pro). Google Workspace accounts send up to 1,000 emails/day on Free (2,000/day on Pro).
        </div>
