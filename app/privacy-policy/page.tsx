...
export default function PrivacyPage() {
  return (
    <SEO title="Privacy Policy" description="SendLib Privacy Policy">
        ...
        <div className="max-w-3xl mx-auto space-y-xl relative">
          ...
          <div className="space-y-lg text-body-md font-body-md text-on-background">
            <section className="space-y-sm">
              <h2 className="font-headline-sm text-headline-sm text-primary-sendlib">1. Information We Collect</h2>
              <p>
            ...
            <section className="space-y-sm">
              <h2 className="font-headline-sm text-headline-sm text-primary-sendlib">2. How We Use Your Information</h2>
              <p>
            ...
            <section className="space-y-sm">
              <h2 className="font-headline-sm text-headline-sm text-primary-sendlib">5. Data Retention</h2>
            ...
            <section className="space-y-sm">
              ...
              <p>
                ...
                <a href="mailto:motionpipehq@gmail.com" className="text-primary-sendlib underline underline-offset-2">
            ...
            <section className="space-y-sm">
              <h2 className="font-headline-sm text-headline-sm text-primary-sendlib">7. Information Sharing</h2>
              <p>
