          ...
          <div className="w-full max-w-105 mx-auto space-y-xl">
            ...
            <div className="space-y-md">
              ...
              <button
                ...
                className="w-full font-label-sm text-label-sm border border-outline-variant text-on-surface bg-white h-12 flex items-center justify-center gap-md rounded-xl transition-transform active:scale-95 hover:bg-surface-container-low"
              >
        ...
        >
          ...
          <div className="space-y-md max-w-115 relative z-10">
            ...
            <p className="font-body-lg text-body-lg text-white/90">
              A secure API designed for developers to bypass restricted hosting environments and send emails instantly.
            </p>
          </div>
